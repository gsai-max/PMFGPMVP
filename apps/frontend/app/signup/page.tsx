  ...
  return (
    <div className="max-w-md mx-auto my-12 bg-white p-8 rounded-3xl border border-gray-100 shadow-xl space-y-6">
      <div className="text-center space-y-1">
        ...
        <p className="text-xs text-gray-500">Join BlinkClone for 10-minute AI quick commerce</p>
      </div>
      ...
      <div className="text-center text-xs text-gray-500">
        ...
        <Link href="/login" className="font-bold text-blinkit-green hover:underline">
          Log In
        </Link>
      </div>
    </div>
