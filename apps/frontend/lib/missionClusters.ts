/**
 * Mission → subcategory cluster → catalog subcategory mapping (frontend mirror of backend config).
 * Kept in sync with apps/backend/src/modules/mission/missionClusters.ts
 */
