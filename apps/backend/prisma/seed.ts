...
// 12 Reference Missions
const MISSIONS = [
  {
    key: 'breakfast',
    displayName: 'Breakfast Prep 🍳',
    checklistCategories: ['Milk & Curd', 'Eggs & Paneer', 'Bread & Buns', 'Tea & Coffee', 'Fresh Fruits'],
    icon: '🍳',
  },
  {
    key: 'dinner_prep',
    displayName: 'Dinner Cooking 🥗',
    checklistCategories: ['Fresh Vegetables', 'Flours & Grains', 'Pulses & Dal', 'Spices & Oils', 'Eggs & Paneer'],
    icon: '🥗',
  },
  {
    key: 'monthly_grocery',
    displayName: 'Monthly Restock 🛒',
    checklistCategories: ['Flours & Grains', 'Pulses & Dal', 'Detergents', 'Oral Care', 'Milk & Curd'],
    icon: '🛒',
  },
  {
    key: 'movie_night',
    displayName: 'Movie & Snack Night 🍿',
    checklistCategories: ['Chips & Namkeen', 'Soft Drinks & Juices', 'Chocolates', 'Frozen Snacks'],
    icon: '🍿',
  },
  {
    key: 'guest_arrival',
  ...
  },
  {
    ...
    checklistCategories: ['Diapers & Wipes', 'Baby Food', 'Baby Skin Care'],
    icon: '🍼',
  },
  {
    key: 'pet_care',
    displayName: 'Pet Care Restock 🐾',
    checklistCategories: ['Pet Food', 'Pet Hygiene', 'Pet Accessories'],
    icon: '🐾',
  },
  {
    key: 'house_cleaning',
...
const TAXONOMY_CATALOG = [
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        products: [
          { name: 'Hybrid Red Tomatoes', price: 28, mrp: 35, unit: '500 g', tags: ['dinner_prep'] },
          { name: 'Fresh Red Onions', price: 32, mrp: 40, unit: '1 kg', tags: ['dinner_prep'] },
          { name: 'New Crop Potatoes', price: 25, mrp: 30, unit: '1 kg', tags: ['dinner_prep'] },
          ...
          { name: 'Green Capsicum (Shimla Mirch)', price: 30, mrp: 40, unit: '250 g', tags: ['dinner_prep'] },
          { name: 'Crisp Green Cucumber', price: 22, mrp: 30, unit: '500 g', tags: ['dinner_prep', 'fitness_nutrition'] },
          { name: 'Fresh Cauliflower (Gobhi)', price: 35, mrp: 45, unit: '1 pc (approx 500g)', tags: ['dinner_prep'] },
          { name: 'Fresh Spinach (Palak)', price: 20, mrp: 25, unit: '250 g', tags: ['dinner_prep', 'fitness_nutrition'] },
          { name: 'Tender Lady Finger (Bhindi)', price: 28, mrp: 35, unit: '250 g', tags: ['dinner_prep'] },
          { name: 'Fresh Green Peas (Matar)', price: 45, mrp: 60, unit: '500 g', tags: ['dinner_prep'] },
          ...
          { name: 'Garlic Bulbs (Lahsun)', price: 45, mrp: 55, unit: '200 g', tags: ['dinner_prep'] },
          ...
          { name: 'Fresh Pumpkin (Kaddu)', price: 22, mrp: 30, unit: '500 g', tags: ['dinner_prep'] },
      ...
      },
      {
        ...
        products: [
          { name: 'Coriander & Green Chillies Combo', price: 15, mrp: 20, unit: '1 pack', tags: ['dinner_prep'] },
          ...
          { name: 'Spicy Green Chillies', price: 15, mrp: 20, unit: '100 g', tags: ['dinner_prep'] },
          { name: 'Fresh Lemongrass', price: 20, mrp: 28, unit: '100 g', tags: ['office_snacks', 'fitness_nutrition'] },
          { name: 'Fresh Sweet Basil Leaves', price: 35, mrp: 45, unit: '50 g', tags: ['dinner_prep'] },
          { name: 'Fresh Parsley', price: 30, mrp: 40, unit: '50 g', tags: ['dinner_prep'] },
          { name: 'Fresh Oregano Leaves', price: 40, mrp: 50, unit: '30 g', tags: ['dinner_prep', 'movie_night'] },
          { name: 'Fresh Rosemary Sprigs', price: 45, mrp: 60, unit: '30 g', tags: ['dinner_prep'] },
          { name: 'Fresh Thyme Leaves', price: 45, mrp: 60, unit: '30 g', tags: ['dinner_prep'] },
          { name: 'Spring Onions with Greens', price: 25, mrp: 35, unit: '250 g', tags: ['dinner_prep'] },
          { name: 'Fresh Celery Sticks', price: 35, mrp: 48, unit: '200 g', tags: ['fitness_nutrition'] },
          { name: 'Fresh Dill Leaves (Suva)', price: 18, mrp: 25, unit: '100 g', tags: ['dinner_prep'] },
          { name: 'Fresh Methi Leaves (Fenugreek)', price: 20, mrp: 28, unit: '250 g', tags: ['dinner_prep', 'breakfast'] },
          { name: 'Fresh Mustard Greens (Sarson)', price: 22, mrp: 30, unit: '250 g', tags: ['dinner_prep'] },
          { name: 'Fresh Sage Leaves', price: 50, mrp: 65, unit: '25 g', tags: ['dinner_prep'] },
    ...
    subcategories: [
      ...
      },
      {
        ...
        products: [
          ...
          { name: 'Amul Fresh Soft Paneer', price: 90, mrp: 105, unit: '200 g', tags: ['dinner_prep'] },
          { name: 'Milky Mist Fresh Paneer Block', price: 98, mrp: 115, unit: '200 g', tags: ['dinner_prep'] },
          ...
          { name: 'Mother Dairy Fresh Paneer', price: 92, mrp: 108, unit: '200 g', tags: ['dinner_prep'] },
          { name: 'Gowardhan Fresh Paneer', price: 88, mrp: 102, unit: '200 g', tags: ['dinner_prep'] },
    ...
    subcategories: [
      {
        ...
        products: [
          ...
          { name: 'Kohinoor Super Value Basmati Rice 1kg', price: 130, mrp: 155, unit: '1 kg', tags: ['dinner_prep'] },
      ...
      },
      {
        ...
        products: [
          ...
          { name: 'Fortune Moong Chilka Split Dal 1kg', price: 155, mrp: 180, unit: '1 kg', tags: ['dinner_prep'] },
          { name: 'Organic Tattva White Lobia Cowpeas 500g', price: 85, mrp: 100, unit: '500 g', tags: ['fitness_nutrition', 'dinner_prep'] },
          { name: 'Rajdhani White Safed Matar 1kg', price: 95, mrp: 115, unit: '1 kg', tags: ['dinner_prep'] },
          { name: 'Tata Sampann Matar Dal 1kg', price: 90, mrp: 105, unit: '1 kg', tags: ['dinner_prep'] },
      ...
      },
      {
        ...
        products: [
          ...
          { name: 'Catch Red Chilli Powder (Lal Mirch) 100g', price: 65, mrp: 75, unit: '100 g', tags: ['dinner_prep'] },
          ...
          { name: 'Everest Coriander Powder (Dhania) 100g', price: 45, mrp: 52, unit: '100 g', tags: ['dinner_prep'] },
          ...
          { name: 'Catch Coriander Powder 100g', price: 44, mrp: 50, unit: '100 g', tags: ['dinner_prep'] },
    ...
    subcategories: [
      ...
      },
      {
        ...
        products: [
          ...
          { name: 'Solimo Non-Stick Parchment Baking Paper', price: 149, mrp: 180, unit: '20 m', tags: ['dinner_prep'] },
...
async function main() {
  ...
  // 1. Seed 12 Reference Missions
  console.log('📌 Seeding 12 reference mission definitions...');
